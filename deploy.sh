...
kubectl set image deployments/client-deployment client=ricopopo92/multi-client:$SHA
kubectl set image deployments/worker-deployment worker=ricopopo92/worker-client:$SHA
